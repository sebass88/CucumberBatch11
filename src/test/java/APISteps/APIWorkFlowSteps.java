...
public class APIWorkFlowSteps {
    ...
    @Then("the employee data we get having ID {string} should match with the globally stored employee id")
    public void the_employee_data_we_get_having_id_should_match_with_the_globally_stored_employee_id(String empIDTemp) {
